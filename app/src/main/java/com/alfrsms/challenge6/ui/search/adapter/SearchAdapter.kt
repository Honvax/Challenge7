package com.alfrsms.challenge6.ui.search.adapter
...
import com.alfrsms.challenge6.databinding.ItemSearchMovieBinding
import com.bumptech.glide.Glide
import com.bumptech.glide.load.resource.drawable.DrawableTransitionOptions


class SearchAdapter(private val itemClick: (SearchItem) -> Unit) :
    ...
    inner class SearchViewHolder(
        ...
        private val itemClick: (SearchItem) -> Unit
    ) :
